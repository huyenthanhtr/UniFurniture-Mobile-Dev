...
public class ProductListViewModel extends AndroidViewModel {
    ...
    private static String sharedCurrentCategoryName = null;
    ...
    private void restoreSharedCache() {
        ...
        currentCategoryName = sharedCurrentCategoryName;
    ...
    private void fetchCurrentPage(boolean isLoadMore) {
        ...
        fetchObserver = response -> {
            ...
            if (response != null && response.items != null) {
                ...
                sharedCurrentCategoryName = currentCategoryName;
    ...
    public void applyFilters(String categoryId, Double minPrice, Double maxPrice, int minRating) {
        currentCategory = categoryId;
        if (categoryId == null) { currentCategoryName = null; sharedCurrentCategoryName = null; }
    ...
    public void setCategoryName(String name) {
        ...
        sharedCurrentCategoryName = name;
    }
    ...
    public void clearFilters() {
        ...
        sharedCurrentCategoryName = null;
