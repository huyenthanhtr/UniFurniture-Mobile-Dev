...
public class ProductListFragment extends Fragment {
    ...
    private void setupSearch() {
        ...
        // Tap backdrop → dismiss search overlay
        binding.searchDimBackdrop.setOnClickListener(v -> {
            hideSuggestions();
            hideSearchHistory();
            InputMethodManager imm = (InputMethodManager) requireContext()
                    .getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void hideSearchHistory() {
        ...
        maybeHideSearchOverlay();
    }

    private void maybeHideSearchOverlay() {
        if (binding.rvSuggestions.getVisibility() != View.VISIBLE
    ...
    private void updateActiveFilterChips() {
        ...
        if (catId != null) {
            String catName = viewModel.getCurrentCategoryName() != null
                    ? viewModel.getCurrentCategoryName() : catId;
