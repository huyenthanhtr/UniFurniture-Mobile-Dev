...
const OrderSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      required: true,
      enum: ["pending", "confirmed", "cancel_pending", "processing", "shipping", "delivered", "completed", "exchange_pending", "cancelled", "exchanged"],
      default: "pending",
    },
    ordered_at: Date,
    ...
    exchange_request: {
      ...
      note: { type: String, default: "" },
      phone: { type: String, default: "" },
      requested_by: { type: String, enum: ["customer", "admin", ""], default: "" },
      requested_at: { type: Date, default: null },
      reviewed_at: { type: Date, default: null },
      status: { type: String, enum: ["", "pending", "approved", "rejected"], default: "" },
      admin_reason: { type: String, default: "" },
